...
exports.onInitialClientRender = () => {
    ...
    let downloadLink = document.querySelector('a[href="/assets/Changing-World-of-Rental-Property-Pet-Damage.pdf"]')
    if (downloadLink) {
      downloadLink.setAttribute("aria-label", "Download Changing World of Rental Property Pet Damage PDF")
    }
  }
